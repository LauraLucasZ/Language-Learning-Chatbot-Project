...
if (isset($_POST['action'])) {
    ...
    switch ($action) {
        ...
        case 'editUser':
            ...
            break;
        case 'removeUser':
            $userManager->removeUser($_POST['id']);
            break;
    }

    // Redirect back to the page to refresh the user list dynamically
...
<body>
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onclick="editUser('<?php echo $user['Id']; ?>', '<?php echo $user['username']; ?>', '<?php echo $user['email']; ?>', '<?php echo $user['role']; ?>', '<?php echo $user['language']; ?>', '<?php echo $user['firstName']; ?>', '<?php echo $user['lastName']; ?>')">Edit</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
    ...
    <script>
        ...
        function editUser(id, username, email, role, language, firstName, lastName) {
            ...
            document.getElementById('user-form').querySelector('input[name="action"]').value = 'editUser'; 
            openForm();
        }
    </script>
